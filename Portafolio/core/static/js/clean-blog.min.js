...
var typed = new Typed('#element', {
    strings: ['<i>"Apasionado desarrollador Fullstack en busca de emocionantes oportunidades para dar mis primeros pasos profesionales en el mundo del desarrollo web."</i>'],
    typeSpeed: 50,
});